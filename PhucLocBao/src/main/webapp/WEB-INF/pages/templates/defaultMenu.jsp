...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class='<%=((PLBSession)request.getSession().getAttribute(PLBSession.SESSION_ATTRIBUTE_KEY)).getMenuBean().getStateClass("notification")%>'><a href="${pageContext.request.contextPath}/notificationContract"><svg class="glyph stroked star"><use xlink:href="#stroked-star"></use></svg>Thông báo</a></li>
